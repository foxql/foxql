...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("../core/middleware.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,i,u,a){try{var o=e[u](a),s=o.value}catch(c){return void r(c)}o.done?t(s):Promise.resolve(s).then(n,i)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(i,u){var a=e.apply(t,n);function o(e){r(a,i,u,o,s,"next",e)}function s(e){r(a,i,u,o,s,"throw",e)}o(void 0)})}}var i=new e.default({timeout:1e3,warningLimit:3}),u="onDocumentByRef";function a(e){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(t){var r,n,u,a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t._by||!1){e.next=3;break}return e.abrupt("return");case 3:if(i.up(r),!i.status(r).warning){e.next=8;break}return void 0!==this.peer.connections[r]&&this.dropPeer(r),e.abrupt("return");case 8:if(n=t.collection,u=t.ref||"",a=this.database.useCollection(n).getDoc(u),!t._simulate||!a){e.next=13;break}return e.abrupt("return",!0);case 13:a&&this.peer.send(r,{listener:t.listener,data:{document:a}});case 14:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var s={name:u,listener:a};exports.default=s;
