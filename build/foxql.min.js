...
"use strict";function t(t){return"string"==typeof t}function e(t){return"number"==typeof t}function r(t){return"[object Date]"===Object.prototype.toString.call(t)?t.isValid():"string"==typeof t&&new Date(t).isValid()}Object.defineProperty(exports,"__esModule",{value:!0}),exports.string=t,exports.number=e,exports.date=r,Date.prototype.isValid=function(){return this.getTime()==this.getTime()};
},{}],"iFZW":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=l;var e=i(require("hash.js")),t=n(require("../utils/typeCheck"));function r(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return r=function(){return e},e}function n(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=r();if(t&&t.has(e))return t.get(e);var n={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var u in e)if(Object.prototype.hasOwnProperty.call(e,u)){var o=i?Object.getOwnPropertyDescriptor(e,u):null;o&&(o.get||o.set)?Object.defineProperty(n,u,o):n[u]=e[u]}return n.default=e,t&&t.set(e,n),n}function i(e){return e&&e.__esModule?e:{default:e}}function u(e){return e.toLowerCase().replace(/[^\w\s]/gi,"").replace(/ +/g,"").trim()}const o={min:(e,t)=>!(t.length<e),max:(e,t)=>!(t.length>e),size:(e,t)=>t.length!==e,type:(e,r)=>{const n=t[e]||!1;return!!n&&n(r)},required:(e,t)=>!t[e],createField:(t,r)=>{let n="";return t.forEach(e=>{n+=u(r[e])}),e.default.sha256().update(n).digest("hex")}},a={createField:!0};function l(e,t,r){let n=!1,i=!1,u=[];for(let l in t){const f=t[l],c=e[l]||!1;for(let t in f){const s=f[t];if(void 0===a[t]){if(!o[t](s,c)){n=!0;break}}else if("createField"==t){const n=o[t](s,e);r==l?i=n:u.push({field:l,value:n})}}}return{fail:n,generatedRef:i,generatedFields:u}}
},{"hash.js":"U6lo","../utils/typeCheck":"xyDD"}],"I9ic":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("./validator.js"));function t(e){return e&&e.__esModule?e:{default:e}}class s{constructor(){this.documents={},this.indexs={},this.ref="id",this.analyzers={},this.indexSeperator=" ",this.documentLength=0,this.analyzerSteps=[],this.documentInfo={},this.waitingSave=!1,this.fields=[],this.schema={}}registerAnalyzer(e,t){this.analyzers[e]=t,this.analyzerSteps.push(e)}addField(e){e.forEach(e=>this.indexs[e]={}),this.fields=e}setRef(e){this.ref=e}setSchema(e){this.schema=e}startAnalyzer(e){return this.analyzerSteps.forEach(t=>{const s=this.analyzers[t];e=s(e)}),e}addDoc(t){const s=(0,e.default)(t,this.schema,this.ref);if(s.fail)return!1;const i=s.generatedRef,n=s.generatedFields;n.length>0&&n.forEach(e=>{t[e.field]=e.value}),i&&(t[this.ref]=i);const r=t[this.ref]||!1;if(!r)return!1;for(let e in t)this.checkField(e)&&e!=this.ref&&this.pushIndex(e,this.startAnalyzer(t[e]),r);return this.documents[r]=t,this.documentLength++,this.waitingSave=!0,!0}createStringIndexMap(e){let t={};return e.split(this.indexSeperator).forEach((e,s)=>{null==t[e]?t[e]=[s]:t[e].push(s)}),t}findStringInMaxTerm(e){let t={};e.split(this.indexSeperator).forEach(e=>{null==t[e]&&(t[e]=0),t[e]++});const s=[];for(let i in t)s.push({keyword:i,count:t[i]});return s.sort((e,t)=>parseFloat(t.count)-parseFloat(e.count)),s[0]}pushIndex(e,t,s){let i=this.createStringIndexMap(t);void 0===this.documentInfo[s]&&(this.documentInfo[s]={}),this.documentInfo[s][e]={indexPosMap:i,bestTerm:this.findStringInMaxTerm(t)};for(let n in i)null==this.indexs[e][n]&&(this.indexs[e][n]={}),this.indexs[e][n][s]=i[n]}checkField(e){return!!this.indexs[e]}deleteDoc(e){const t=this.getDoc(e);if(!t)return!1;for(let s in t){if(!this.checkField(s)||s==this.ref)continue;const i=this.createStringIndexMap(this.startAnalyzer(t[s]));for(let t in i)delete this.indexs[s][t][e],Object.keys(this.indexs[s][t]).length<=0&&delete this.indexs[s][t]}return delete this.documents[e],delete this.documentInfo[e],this.documentLength--,this.waitingSave=!0,!0}getDoc(e){return this.documents[e]||!1}search(e){let t={};this.startAnalyzer(e).split(this.indexSeperator).forEach(e=>{for(let s in this.indexs){const i=this.indexs[s][e]||!1;if(!i)continue;const n=Object.keys(i);n.length<=0||n.forEach(i=>{const n=this.documents[i],r=this.documentInfo[i][s];null==t[i]&&(t[i]={document:n,score:0});const h=r.indexPosMap[e]||[];h.length>0&&(t[i].score+=h.length/r.bestTerm.count)})}});let s=[];for(let i in t)s.push(t[i]);return s.sort((e,t)=>parseFloat(t.score)-parseFloat(e.score)),s}export(){return this.documents}}var i=s;exports.default=i;
},{"./validator.js":"iFZW"}],"bIc9":[function(require,module,exports) {
module.exports={_from:"@foxql/foxql-index@latest",_id:"@foxql/foxql-index@1.0.15",_inBundle:!1,_integrity:"sha512-2Ywd/zGAdziQorWNCky6WCIVxVYzDJzqFVwLEHPEwmzxglWDU9PjBfv8Am8y9dgAuz19RLNOs8lmSR49tKsptQ==",_location:"/@foxql/foxql-index",_phantomChildren:{},_requested:{type:"tag",registry:!0,raw:"@foxql/foxql-index@latest",name:"@foxql/foxql-index",escapedName:"@foxql%2ffoxql-index",scope:"@foxql",rawSpec:"latest",saveSpec:null,fetchSpec:"latest"},_requiredBy:["#USER","/"],_resolved:"https://registry.npmjs.org/@foxql/foxql-index/-/foxql-index-1.0.15.tgz",_shasum:"fa96d534dffecd05a1badf3a74bb1e20a1a2168d",_spec:"@foxql/foxql-index@latest",_where:"C:\\xampp\\htdocs\\foxql",author:{name:"Bora Erdinç Özer"},bugs:{url:"https://github.com/foxql/database/issues"},bundleDependencies:!1,dependencies:{"hash.js":"^1.1.7"},deprecated:!1,description:"javascript object based inverted index implementation",devDependencies:{"parcel-bundler":"^1.12.4"},homepage:"https://github.com/foxql/database#readme",keywords:["inverted","index","search","engine","foxql"],license:"ISC",main:"index.js",name:"@foxql/foxql-index",repository:{type:"git",url:"git+https://github.com/foxql/database.git"},scripts:{dev:"parcel develop/index.html",test:'echo "Error: no test specified" && exit 1'},version:"1.0.15"};
},{}],"tCzD":[function(require,module,exports) {
exports.encode=((r,e=64)=>{if(!r)return r;var t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_!#%()*+,./:;=?@[]^{|}~ $`";t+="\b\t\v\f÷&'>\0\n\r\"<\\";var a=e*e*e,o=new Map,n=256,h=Math.log2(e),c=(r=unescape(encodeURIComponent(r)).split(""))[0],v=[];function f(r){for(var a=r.length>1?o.get(r):r.charCodeAt(0),c=1+(Math.log2(n)/h|0);c;c--)v.push(t[a%e]),a=a/e|0}for(var g=1;g<r.length;g++){var p=r[g];o.has(c+p)?c+=p:(o.set(c+p,n),f(c),c=p,++n==a-1&&(o.clear(),n=256))}return f(c),v.join("")}),exports.decode=((r,e=64)=>{var t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_!#%()*+,./:;=?@[]^{|}~ $`";t+="\b\t\v\f÷&'>\0\n\r\"<\\";for(var a=e*e*e,o={},n=0;n<e;n++)o[t.charAt(n)]=n;var h=new Map,c=257,v=Math.log2(e),f=8/v|0;n=0;function g(t=0){return o[r[n++]]+(t==f?0:e*g(t+1))}for(var p=String.fromCharCode(g()),s=p,l=[p];n<r.length;){f=Math.log2(c++)/v|0;var d=g();p=d<256?String.fromCharCode(d):h.has(d)?h.get(d):p+p.charAt(0),l.push(p),c==a-1&&(h.clear(),c=256),h.set(c-2,s+p.charAt(0)),s=p}return decodeURIComponent(escape(l.join("")))});
},{}],"MOJc":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=s(require("./src/core/invertedIndex")),t=require("./package.json"),o=require("./src/utils/lz77");function s(e){return e&&e.__esModule?e:{default:e}}class c{constructor(){this.collections={},this.version=t.version}pushCollection({collectionName:t,fields:o,ref:s,schema:c}){let i=new e.default;i.addField(o),i.setRef(s),i.setSchema(c),this.collections[t]=i}useCollection(e){return this.collections[e]||!1}export(){let e={collections:{},version:this.version};const t=this.collections;for(let o in t){const s=t[o];e.collections[o]=s.export()}return(0,o.encode)(JSON.stringify(e))}import(e){const t=(0,o.decode)(e),s=JSON.parse(t).collections;for(let o in s){if(void 0===this.collections[o])continue;const e=Object.values(s[o]),t=this.useCollection(o);e.forEach(e=>{t.addDoc(e)})}return!0}}var i=c;exports.default=i;
},{"./src/core/invertedIndex":"I9ic","./package.json":"bIc9","./src/utils/lz77":"tCzD"}],"KA2S":[function(require,module,exports) {
var define;
...
},{"../utils/middleware.js":"ReQA"}],"Rgfk":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=u(require("./events/onDocument.js")),t=u(require("./events/onSearch.js")),n=u(require("./events/onRandom.js")),o=u(require("./events/onDocumentByRef.js"));function u(e){return e&&e.__esModule?e:{default:e}}var r={onDocument:e.default,onSearch:t.default,onRandom:n.default,onDocumentByRef:o.default};exports.default=r;
},{"./events/onDocument.js":"r7na","./events/onSearch.js":"JhzZ","./events/onRandom.js":"Opt2","./events/onDocumentByRef.js":"r62l"}],"Ln1Q":[function(require,module,exports) {
