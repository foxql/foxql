...
},{}],"r7na":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("../utils/middleware.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,u,i,a){try{var o=e[i](a),s=o.value}catch(c){return void r(c)}o.done?t(s):Promise.resolve(s).then(n,u)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(u,i){var a=e.apply(t,n);function o(e){r(a,u,i,o,s,"next",e)}function s(e){r(a,u,i,o,s,"throw",e)}o(void 0)})}}var u=new e.default({timeout:1e3,warningLimit:1}),i="onDocument";function a(e){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(t){var r,n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!t._simulate){e.next=2;break}return e.abrupt("return",!0);case 2:if(r=t._by||!1){e.next=5;break}return e.abrupt("return",!1);case 5:if(u.up(r),!u.status(r).warning){e.next=10;break}return void 0!==this.peer.connections[r]&&this.dropPeer(r),e.abrupt("return",!1);case 10:n=t.collection,this.database.useCollection(n).addDoc(t.document);case 12:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var s={name:i,listener:a};exports.default=s;
},{"../utils/middleware.js":"ReQA"}],"JhzZ":[function(require,module,exports) {
...
},{"../utils/middleware.js":"ReQA"}],"R9U6":[function(require,module,exports) {
"use strict";function e(e,t,r,n,u,o,a){try{var i=e[o](a),s=i.value}catch(c){return void r(c)}i.done?t(s):Promise.resolve(s).then(n,u)}function t(t){return function(){var r=this,n=arguments;return new Promise(function(u,o){var a=t.apply(r,n);function i(t){e(a,u,o,i,s,"next",t)}function s(t){e(a,u,o,i,s,"throw",t)}i(void 0)})}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var r="onSync";function n(e){return u.apply(this,arguments)}function u(){return(u=t(regeneratorRuntime.mark(function e(t){var r,n,u,o=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t._by,n=this.database.useCollection("entry_offers"),!t._simulate){e.next=6;break}if(!(n.documentLength<=0)){e.next=5;break}return e.abrupt("return",!1);case 5:return e.abrupt("return",!0);case 6:return u=this.database.useCollection("entrys"),Object.values(n.documents).forEach(function(e){var a=u.getDoc(e.entryId);if(a){if(e.recieverCount>=e.destroyRecieveCount)return n.deleteDoc(e.entryOfferId),!0;o.peer.send(r,{listener:t.listener,data:{results:a}})}e.recieverCount+=1}),e.abrupt("return",!0);case 10:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var o={listener:n,name:r};exports.default=o;
},{}],"Rgfk":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("./events/onDocument.js")),n=r(require("./events/onSearch.js")),t=r(require("./events/onRandom.js")),o=r(require("./events/onDocumentByRef.js")),u=r(require("./events/onSync.js"));function r(e){return e&&e.__esModule?e:{default:e}}var s={onDocument:e.default,onSearch:n.default,onRandom:t.default,onDocumentByRef:o.default,onSync:u.default};exports.default=s;
},{"./events/onDocument.js":"r7na","./events/onSearch.js":"JhzZ","./events/onRandom.js":"Opt2","./events/onDocumentByRef.js":"r62l","./events/onSync.js":"R9U6"}],"Ln1Q":[function(require,module,exports) {
