...
},{"./hash/utils":"nkOw","./hash/common":"d5ks","./hash/sha":"yBIv","./hash/ripemd":"hfbr","./hash/hmac":"Z8Lw"}],"hoW8":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=n;var e=t(require("hash.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e){return e.toLowerCase().replace(/[^\w\s]/gi,"").replace(/ +/g,"").trim()}const i={min:(e,t)=>!(t.length<e),max:(e,t)=>!(t.length>e),size:(e,t)=>t.length!==e,type:(e,t)=>typeof t===e,required:(e,t)=>!t[e],createField:(t,i)=>{let l="";return t.forEach(e=>{l+=r(i[e])}),e.default.sha256().update(l).digest("hex")}},l={createField:!0};function n(e,t,r){let n=!1,a=!1,s=[];for(let o in t){const u=t[o],d=e[o]||!1;for(let t in u){const f=u[t];if(void 0===l[t]){if(!i[t](f,d)){n=!0;break}}else if("createField"==t){const l=i[t](f,e);r==o?a=l:s.push({field:o,value:l})}}}return{fail:n,generatedRef:a,generatedFields:s}}
},{"hash.js":"U6lo"}],"t1Jy":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("./foxql-validator.js"));function t(e){return e&&e.__esModule?e:{default:e}}class s{constructor(){this.documents={},this.indexs={},this.ref="id",this.analyzers={},this.indexSeperator=" ",this.documentLength=0,this.analyzerSteps=[],this.documentInfo={},this.waitingSave=!1,this.fields=[],this.schema={}}registerAnalyzer(e,t){this.analyzers[e]=t,this.analyzerSteps.push(e)}addField(e){e.forEach(e=>this.indexs[e]={}),this.fields=e}setRef(e){this.ref=e}setSchema(e){this.schema=e}startAnalyzer(e){return this.analyzerSteps.forEach(t=>{const s=this.analyzers[t];e=s(e)}),e}addDoc(t){const s=(0,e.default)(t,this.schema,this.ref);if(s.fail)return;const n=s.generatedRef,i=s.generatedFields;i.length>0&&i.forEach(e=>{t[e.field]=e.value}),n&&(t[this.ref]=n);const r=t[this.ref]||!1;if(!r)return!1;for(let e in t)this.checkField(e)&&e!=this.ref&&this.pushIndex(e,this.startAnalyzer(t[e]),r);return this.documents[r]=t,this.documentLength++,this.waitingSave=!0,!0}createStringIndexMap(e){let t={};return e.split(this.indexSeperator).forEach((e,s)=>{null==t[e]?t[e]=[s]:t[e].push(s)}),t}findStringInMaxTerm(e){let t={};e.split(this.indexSeperator).forEach(e=>{null==t[e]&&(t[e]=0),t[e]++});const s=[];for(let n in t)s.push({keyword:n,count:t[n]});return s.sort((e,t)=>parseFloat(t.count)-parseFloat(e.count)),s[0]}pushIndex(e,t,s){let n=this.createStringIndexMap(t);void 0===this.documentInfo[s]&&(this.documentInfo[s]={}),this.documentInfo[s][e]={indexPosMap:n,bestTerm:this.findStringInMaxTerm(t)};for(let i in n)null==this.indexs[e][i]&&(this.indexs[e][i]={}),this.indexs[e][i][s]=n[i]}checkField(e){return!!this.indexs[e]}deleteDoc(e){const t=this.getDoc(e);if(!t)return!1;for(let s in t){if(!this.checkField(s)||s==this.ref)continue;const n=this.createStringIndexMap(this.startAnalyzer(t[s]));for(let t in n)delete this.indexs[s][t][e],Object.keys(this.indexs[s][t]).length<=0&&delete this.indexs[s][t]}return delete this.documents[e],delete this.documentInfo[e],this.documentLength--,this.waitingSave=!0,!0}getDoc(e){return this.documents[e]||!1}search(e){let t={};this.startAnalyzer(e).split(this.indexSeperator).forEach(e=>{for(let s in this.indexs){const n=this.indexs[s][e]||!1;if(!n)continue;const i=Object.keys(n);i.length<=0||i.forEach(n=>{const i=this.documents[n],r=this.documentInfo[n][s];null==t[n]&&(t[n]={document:i,score:0});const h=r.indexPosMap[e]||[];h.length>0&&(t[n].score+=h.length/r.bestTerm.count*e.length)})}});let s=[];for(let n in t)s.push(t[n]);return s.sort((e,t)=>parseFloat(t.score)-parseFloat(e.score)),s}export(){return JSON.stringify({documents:this.documents,indexs:this.indexs,documentLength:this.documentLength,documentInfo:this.documentInfo,fields:this.fields,ref:this.ref,schema:this.schema})}import(e){const t=JSON.parse(e);return this.addField(t.fields),this.setRef(t.ref),this.setSchema(t.schema),this.documents=t.documents,this.indexs=t.indexs,this.documentLength=t.documentLength,this.documentInfo=t.documentInfo,!0}}var n=s;exports.default=n;
},{"./foxql-validator.js":"hoW8"}],"MOJc":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("./src/foxql-index.js"));function t(e){return e&&e.__esModule?e:{default:e}}class o{constructor(){this.collections={}}pushCollection({collectionName:t,fields:o,ref:l,schema:s}){let c=new e.default;c.addField(o),c.setRef(l),c.setSchema(s),this.collections[t]=c}useCollection(e){return this.collections[e]||!1}export(){let e={};const t=this.collections;for(let o in t){const l=t[o];e[o]=l.export()}return e}import(t){for(let o in t){const l=new e.default;l.import(t[o]),this.collections[o]=l}}}var l=o;exports.default=l;
},{"./src/foxql-index.js":"t1Jy"}],"KA2S":[function(require,module,exports) {
var define;
...
},{"regenerator-runtime/runtime":"KA2S","socket.io-client":"FOlW","./src/events.js":"YGbh","./src/untils/peer.js":"sRWu","./src/untils/random.js":"chlz","./src/models/dataModel.js":"Yt0j","process":"g5IB"}],"EDnG":[function(require,module,exports) {
...
},{}],"ZfsO":[function(require,module,exports) {
...
},{}],"ISy9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("../core/middleware.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,u,i,a){try{var o=e[i](a),s=o.value}catch(c){return void r(c)}o.done?t(s):Promise.resolve(s).then(n,u)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(u,i){var a=e.apply(t,n);function o(e){r(a,u,i,o,s,"next",e)}function s(e){r(a,u,i,o,s,"throw",e)}o(void 0)})}}var u=new e.default({timeout:1e3,warningLimit:1}),i="onDocument";function a(e){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(t){var r,n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!t._simulate){e.next=2;break}return e.abrupt("return",!0);case 2:if(r=t._by||!1){e.next=5;break}return e.abrupt("return");case 5:if(u.up(r),!u.status(r).warning){e.next=10;break}return void 0!==this.peer.connections[r]&&this.dropPeer(r),e.abrupt("return");case 10:n=t.collection,this.database.useCollection(n).addDoc(t.document);case 12:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var s={name:i,listener:a};exports.default=s;
},{"../core/middleware.js":"ZfsO"}],"q3xn":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("../core/middleware.js"));function r(e){return e&&e.__esModule?e:{default:e}}function t(e,r,t,n,i,u,a){try{var o=e[u](a),s=o.value}catch(c){return void t(c)}o.done?r(s):Promise.resolve(s).then(n,i)}function n(e){return function(){var r=this,n=arguments;return new Promise(function(i,u){var a=e.apply(r,n);function o(e){t(a,i,u,o,s,"next",e)}function s(e){t(a,i,u,o,s,"throw",e)}o(void 0)})}}var i=new e.default({timeout:1e3,warningLimit:5}),u="onSearch";function a(e){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(r){var t,n,u,a,o=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(void 0!==r.query){e.next=2;break}return e.abrupt("return",!0);case 2:if(t=r._by,i.up(t),!i.status(t).warning){e.next=8;break}return void 0!==this.peer.connections[t]&&this.dropPeer(t),e.abrupt("return");case 8:if(n=r.collections,u={},a=0,n.forEach(function(e){var t=o.database.useCollection(e);u[e]=t.search(r.query),a+=u[e].length}),!r._simulate){e.next=14;break}return e.abrupt("return",a>0);case 14:this.peer.send(t,{listener:r.listener,data:{results:u}});case 15:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var s={name:u,listener:a};exports.default=s;
},{"../core/middleware.js":"ZfsO"}],"rZTf":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("../core/middleware.js"));function r(e){return e&&e.__esModule?e:{default:e}}function t(e){throw new TypeError('"'+e+'" is read-only')}function n(e,r,t,n,i,u,a){try{var o=e[u](a),s=o.value}catch(c){return void t(c)}o.done?r(s):Promise.resolve(s).then(n,i)}function i(e){return function(){var r=this,t=arguments;return new Promise(function(i,u){var a=e.apply(r,t);function o(e){n(a,i,u,o,s,"next",e)}function s(e){n(a,i,u,o,s,"throw",e)}o(void 0)})}}var u=new e.default({timeout:1e3,warningLimit:5}),a="onRandom";function o(e){return s.apply(this,arguments)}function s(){return(s=i(regeneratorRuntime.mark(function e(r){var n,i,a,o,s,c,l,d,f,p,h;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!r._simulate){e.next=2;break}return e.abrupt("return",!0);case 2:if(n=r._by,u.up(n),!u.status(n).warning){e.next=8;break}return void 0!==this.peer.connections[n]&&this.dropPeer(n),e.abrupt("return");case 8:if(void 0!==r.listener){e.next=10;break}return e.abrupt("return");case 10:if((i=r.limit||3)>3&&(t("limit"),i=3),a=r.collection||"",this.currentCollections.includes(a)){e.next=15;break}return e.abrupt("return",!1);case 15:if(o=this.database.useCollection(a),s=Object.values(o.documents),!((c=s.length)<=0)){e.next=20;break}return e.abrupt("return",!1);case 20:if(c>100&&(s=document.slice(0,100),c=100),l=[],d={},c<=i)l=s;else for(f=0;f<i;f++)p=Math.floor(Math.random()*c),h=s[p],void 0===d[h[o.ref]]&&(l.push(h),s.splice(p,1),c--);this.peer.send(n,{listener:r.listener,data:{results:l}});case 25:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var c={name:a,listener:o};exports.default=c;
},{"../core/middleware.js":"ZfsO"}],"zeUc":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("../core/middleware.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,i,u,a){try{var o=e[u](a),s=o.value}catch(c){return void r(c)}o.done?t(s):Promise.resolve(s).then(n,i)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(i,u){var a=e.apply(t,n);function o(e){r(a,i,u,o,s,"next",e)}function s(e){r(a,i,u,o,s,"throw",e)}o(void 0)})}}var i=new e.default({timeout:1e3,warningLimit:3}),u="onDocumentByRef";function a(e){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(t){var r,n,u,a,o,s,c,f,l,p;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t._by||!1){e.next=3;break}return e.abrupt("return");case 3:if(i.up(r),!i.status(r).warning){e.next=8;break}return void 0!==this.peer.connections[r]&&this.dropPeer(r),e.abrupt("return");case 8:if(n=t.collection,u=t.ref||"",a=this.database.useCollection(n),o=[],(s=a.getDoc(u))&&o.push(s),(c=t.match||!1)&&(f=c.field||"",l=s[f]||!1,(p=a.indexs[f]||!1)&&l&&Object.keys(p[l]).forEach(function(e){e!=s[a.ref]&&o.push(a.getDoc(e))})),!t._simulate||!s){e.next=18;break}return e.abrupt("return",!0);case 18:s&&this.peer.send(r,{listener:t.listener,data:{results:o}});case 19:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var s={name:u,listener:a};exports.default=s;
},{"../core/middleware.js":"ZfsO"}],"Bvf5":[function(require,module,exports) {
...
},{"./events/onDocument.js":"ISy9","./events/onSearch.js":"q3xn","./events/onRandom.js":"rZTf","./events/onDocumentByRef.js":"zeUc"}],"s6gn":[function(require,module,exports) {
...
},{}],"Ebtf":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=[{collectionName:"entrys",fields:["title","content","entryKey"],ref:"documentId",schema:{title:{type:"string",min:3,max:80,required:!0},content:{type:"string",min:7,max:500,required:!0},documentId:{createField:["title","content"]},entryKey:{createField:["title"]}}},{collectionName:"webPage",fields:["title","description","domain","url"],ref:"documentId",schema:{title:{type:"string",min:4,max:70,required:!0},description:{type:"string",min:7,max:255,required:!0},url:{type:"string",min:6,max:175,required:!0},domain:{type:"string",min:6,max:35,required:!0},documentId:{createField:["url"]},documentSubId:{createField:["domain"]}}}];exports.default=e;
},{}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=i(require("@foxql/foxql-index")),t=i(require("@foxql/foxql-peer")),n=i(require("./core/storage.js")),r=i(require("./events.js")),o=i(require("./core/tokenization.js")),a=i(require("./collections.js"));function i(e){return e&&e.__esModule?e:{default:e}}function s(e,t,n,r,o,a,i){try{var s=e[a](i),u=s.value}catch(c){return void n(c)}s.done?t(u):Promise.resolve(u).then(r,o)}function u(e){return function(){var t=this,n=arguments;return new Promise(function(r,o){var a=e.apply(t,n);function i(e){s(a,r,o,i,u,"next",e)}function u(e){s(a,r,o,i,u,"throw",e)}i(void 0)})}}function c(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function l(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{};t%2?c(Object(n),!0).forEach(function(t){f(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):c(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function f(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function p(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function h(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function v(e,t,n){return t&&h(e.prototype,t),n&&h(e,n),e}var d=function(){function i(){p(this,i),this.storageOptions={name:"foxql-storage",interval:100,saveInterval:!1},this.currentCollections=[],this.documentLengthInterval={active:!1,ms:500,maxDocumentLength:100},this.useAvaliableObjects=["serverOptions","storageOptions","documentLengthInterval"],this.databaseSaveProcessing=!1,this.database=new e.default,this.peer=new t.default}return v(i,[{key:"use",value:function(e,t){this.useAvaliableObjects.includes(e)&&(this[e]=l(l({},this[e]),t))}},{key:"openNativeCollections",value:function(){var e=this;a.default.forEach(function(t){e.database.pushCollection(t);var n=t.collectionName;e.currentCollections.push(n),e.database.useCollection(n).registerAnalyzer("tokenizer",o.default)})}},{key:"open",value:function(){var e=this.storageOptions.saveInterval||!1;e&&(this.storage=new n.default(this.storageOptions),this.loadDumpOnStorage()),e&&this.indexDatabaseLoop(),this.documentLengthInterval.active&&this.deleteDatabaseLoop(),this.peer.open()}},{key:"deleteDatabaseLoop",value:function(){var e=this,t=this.documentLengthInterval;setInterval(function(){t.maxDocumentsInCollections.forEach(function(t){var n=t.collection,r=t.maxDocument,o=e.database.useCollection(n);if(o.documentLength>r){var a=Object.keys(o.documents).pop();o.deleteDoc(a)}})},t.interval)}},{key:"loadDumpOnStorage",value:function(){var e=this,t=this.storage.get();if(t&&"string"==typeof t)try{this.database.import(JSON.parse(t)),a.default.forEach(function(t){var n=t.collectionName;e.database.useCollection(n).registerAnalyzer("tokenizer",o.default)})}catch(n){throw Error(n)}}},{key:"indexDatabaseLoop",value:function(){var e=this;setInterval(function(){e.currentCollections.forEach(function(t){var n=e.database.collections[t];if(n.waitingSave&&!e.databaseSaveProcessing){e.databaseSaveProcessing=!0;var r=e.database.export();e.storage.set(JSON.stringify(r)),e.databaseSaveProcessing=!1,n.waitingSave=!1}})},this.storageOptions.interval)}},{key:"pushEvents",value:function(e){var t=this;e.forEach(function(e){var n=r.default[e]||!1;n&&t.peer.onPeer(n.name,n.listener.bind(t))})}},{key:"publishDocument",value:function(){var e=u(regeneratorRuntime.mark(function e(t,n){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if("string"==typeof n){e.next=2;break}return e.abrupt("return",!1);case 2:if(this.currentCollections.includes(n)){e.next=4;break}return e.abrupt("return",!1);case 4:return e.next=6,this.peer.broadcast({listener:"onDocument",data:{document:t,collection:n}});case 6:case"end":return e.stop()}},e,this)}));return function(t,n){return e.apply(this,arguments)}}()},{key:"randomString",value:function(){return Math.random().toString(36).substring(0,30).replace(/\./gi,"")}},{key:"search",value:function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o,a,i,s,c,l,f=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.query,r=t.timeOut,o=t.collections,a=[],i={},s=0,null==o&&(o=this.currentCollections),c=this.randomString(),l={listener:c,query:n,collections:o},e.next=9,this.peer.broadcast({listener:"onSearch",data:l});case 9:return this.peer.onPeer(c,function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:for(o in n=t.results,r=function(e){var t=n[e];s+=t.length,t.forEach(function(t){null==i[t.document.documentId]&&(t._collection=e,a.push(t),i[t.document.documentId]=1)})},n)r(o);case 3:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),e.abrupt("return",new Promise(function(e,t){setTimeout(function(){a.sort(function(e,t){return t.document.score-e.document.score}),delete f.peer.peerEvents[c],e({results:a,count:s})},r+500)}));case 11:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"randomDocument",value:function(){var e=u(regeneratorRuntime.mark(function e(t,n){var r,o,a,i,s,c=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=t.limit,o=t.collection,a=t.timeOut,i=this.randomString(),e.next=4,this.peer.broadcast({listener:"onRandom",data:{limit:r,collection:o,listener:i}});case 4:s=[],this.peer.onPeer(i,function(){var e=u(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:s=s.concat(t.results);case 1:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),setTimeout(function(){n(s),delete c.peer.peerEvents[i]},a);case 7:case"end":return e.stop()}},e,this)}));return function(t,n){return e.apply(this,arguments)}}()},{key:"findDocument",value:function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o,a,i,s,c=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.collection,r=t.ref,o=t.timeOut,a=t.match,i=this.randomString(),s=[],this.peer.onPeer(i,function(){var e=u(regeneratorRuntime.mark(function e(t){var n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:(n=t.results).length>0&&(s=s.concat(n));case 2:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),e.next=6,this.peer.broadcast({listener:"onDocumentByRef",data:{listener:i,ref:r,collection:n,match:a||!1}});case 6:return e.abrupt("return",new Promise(function(e){setTimeout(function(){e(s),delete c.peer.peerEvents[i]},o)}));case 7:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"dropPeer",value:function(e){void 0!==this.peer.connections[e]&&(this.peer.connections[e].dataChannel.close(),delete this.peer.connections[e])}}]),i}(),m=d;exports.default=m;
},{"@foxql/foxql-index":"MOJc","@foxql/foxql-peer":"yhko","./core/storage.js":"EDnG","./events.js":"Bvf5","./core/tokenization.js":"s6gn","./collections.js":"Ebtf"}],"Amr1":[function(require,module,exports) {
