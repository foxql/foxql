...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("../utils/middleware.js"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,i,u,a){try{var s=e[u](a),o=s.value}catch(c){return void r(c)}s.done?t(o):Promise.resolve(o).then(n,i)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(i,u){var a=e.apply(t,n);function s(e){r(a,i,u,s,o,"next",e)}function o(e){r(a,i,u,s,o,"throw",e)}s(void 0)})}}var i=new e.default({timeout:1e3,warningLimit:5}),u="onRandom";function a(e){return s.apply(this,arguments)}function s(){return(s=n(regeneratorRuntime.mark(function e(t){var r,n,u,a,s,o,c,l,d,f,p;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t._by,i.up(r),!i.status(r).warning){e.next=6;break}return void 0!==this.peer.connections[r]&&this.dropPeer(r),e.abrupt("return");case 6:if(void 0!==t.listener){e.next=8;break}return e.abrupt("return");case 8:if((n=t.limit||10)>20&&(n=20),u=t.collection||"",this.currentCollections.includes(u)){e.next=13;break}return e.abrupt("return",!1);case 13:if(a=this.database.useCollection(u),s=Object.values(a.documents),!((o=s.length)<=0)){e.next=18;break}return e.abrupt("return",!1);case 18:if(!t._simulate){e.next=20;break}return e.abrupt("return",!0);case 20:if(o>100&&(s=document.slice(0,100),o=100),c=[],l={},o<=n)c=s;else for(d=0;d<n;d++)f=Math.floor(Math.random()*o),p=s[f],void 0===l[p[a.ref]]&&(c.push(p),s.splice(f,1),o--);this.peer.send(r,{listener:t.listener,data:{results:c}});case 25:case"end":return e.stop()}},e,this)}))).apply(this,arguments)}var o={name:u,listener:a};exports.default=o;
...
},{"./src/foxql.js":"cJg3","./src/utils/middleware.js":"ReQA"}],"Amr1":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.client=void 0;var e=t(require("./index.js"));function t(e){return e&&e.__esModule?e:{default:e}}var r=new e.default;exports.client=r;
},{"./index.js":"Focm"}]},{},["Amr1"], "foxql")