...
},{}],"GYpM":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("hash.js"));function t(e){return e&&e.__esModule?e:{default:e}}function n(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function r(e,t,n){return t&&i(e.prototype,t),n&&i(e,n),e}var a=function(){function t(){n(this,t),this.hashMap={},this.participantsCount=0,this.uniqueDocumentCount=0,this.requirementMinFrequency=.8,this.requirementMinParticipantsByDocument=.6,this.percentParticipants=0}return r(t,[{key:"add",value:function(e,t){var n=t.sender,i=this.makeKey(e);if(this.check(i))return this.hashMap[i]={doc:e,count:1,genesisRecieveTime:new Date,recievePoolingTime:0,senderCount:1,senderMap:{}},this.hashMap[i].senderMap[n]=t,this.uniqueDocumentCount++,!0;this.up(i,n)}},{key:"up",value:function(e,t){var n=this.hashMap[e];n.count+=1;var i=new Date;n.recievePoolingTime=i.getTime()-n.genesisRecieveTime.getTime(),void 0===n.senderMap[t]?(n.senderMap[t]=1,n.senderCount++):n.senderMap[t]++}},{key:"check",value:function(e){return void 0===this.hashMap[e]}},{key:"makeKey",value:function(t){return e.default.sha256().update(JSON.stringify(t)).digest("hex")}},{key:"calculateDifficulty",value:function(e){var t=e.senderCount,n=t*this.requirementMinParticipantsByDocument;return!(this.percentParticipants>n)&&!(t/e.count<this.requirementMinFrequency)}},{key:"results",value:function(){var e=this;return this.percentParticipants=this.requirementMinParticipantsByDocument,Object.values(this.hashMap).filter(function(t){return e.calculateDifficulty(t)})}}]),t}(),u=a;exports.default=u;
},{"hash.js":"U6lo"}],"olCK":[function(require,module,exports) {
