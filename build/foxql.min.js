...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("./foxql-validator.js"));function t(e){return e&&e.__esModule?e:{default:e}}class s{constructor(){this.documents={},this.indexs={},this.ref="id",this.analyzers={},this.indexSeperator=" ",this.documentLength=0,this.analyzerSteps=[],this.documentInfo={},this.waitingSave=!1,this.fields=[],this.schema={}}registerAnalyzer(e,t){this.analyzers[e]=t,this.analyzerSteps.push(e)}addField(e){e.forEach(e=>this.indexs[e]={}),this.fields=e}setRef(e){this.ref=e}setSchema(e){this.schema=e}startAnalyzer(e){return this.analyzerSteps.forEach(t=>{const s=this.analyzers[t];e=s(e)}),e}addDoc(t){const s=(0,e.default)(t,this.schema,this.ref);if(s.fail)return;const i=s.generatedRef,n=s.generatedFields;n.length>0&&n.forEach(e=>{t[e.field]=e.value}),i&&(t[this.ref]=i);const r=t[this.ref]||!1;if(!r)return!1;for(let e in t)this.checkField(e)&&e!=this.ref&&this.pushIndex(e,this.startAnalyzer(t[e]),r);return this.documents[r]=t,this.documentLength++,this.waitingSave=!0,!0}createStringIndexMap(e){let t={};return e.split(this.indexSeperator).forEach((e,s)=>{null==t[e]?t[e]=[s]:t[e].push(s)}),t}findStringInMaxTerm(e){let t={};e.split(this.indexSeperator).forEach(e=>{null==t[e]&&(t[e]=0),t[e]++});const s=[];for(let i in t)s.push({keyword:i,count:t[i]});return s.sort((e,t)=>parseFloat(t.count)-parseFloat(e.count)),s[0]}pushIndex(e,t,s){let i=this.createStringIndexMap(t);void 0===this.documentInfo[s]&&(this.documentInfo[s]={}),this.documentInfo[s][e]={indexPosMap:i,bestTerm:this.findStringInMaxTerm(t)};for(let n in i)null==this.indexs[e][n]&&(this.indexs[e][n]={}),this.indexs[e][n][s]=i[n]}checkField(e){return!!this.indexs[e]}deleteDoc(e){const t=this.getDoc(e);if(!t)return!1;for(let s in t){if(!this.checkField(s)||s==this.ref)continue;const i=this.createStringIndexMap(this.startAnalyzer(t[s]));for(let t in i)delete this.indexs[s][t][e],Object.keys(this.indexs[s][t]).length<=0&&delete this.indexs[s][t]}return delete this.documents[e],this.documentLength--,this.waitingSave=!0,!0}getDoc(e){return this.documents[e]||!1}search(e){let t={};this.startAnalyzer(e).split(this.indexSeperator).forEach(e=>{for(let s in this.indexs){const i=this.indexs[s][e]||!1;if(!i)continue;const n=Object.keys(i);n.length<=0||n.forEach(i=>{const n=this.documents[i],r=this.documentInfo[i][s];null==t[i]&&(t[i]={document:n,score:0});const h=r.indexPosMap[e]||[];h.length>0&&(t[i].score+=h.length/r.bestTerm.count*e.length)})}});let s=[];for(let i in t)s.push(t[i]);return s.sort((e,t)=>parseFloat(t.score)-parseFloat(e.score)),s}export(){return JSON.stringify({documents:this.documents,indexs:this.indexs,documentLength:this.documentLength,documentInfo:this.documentInfo,fields:this.fields,ref:this.ref,schema:this.schema})}import(e){const t=JSON.parse(e);return this.addField(t.fields),this.setRef(t.ref),this.setSchema(t.schema),this.documents=t.documents,this.indexs=t.indexs,this.documentLength=t.documentLength,this.documentInfo=t.documentInfo,!0}}var i=s;exports.default=i;
...
"use strict";function e(e,n,t,r,o,i,u){try{var c=e[i](u),a=c.value}catch(s){return void t(s)}c.done?n(a):Promise.resolve(a).then(r,o)}function n(n){return function(){var t=this,r=arguments;return new Promise(function(o,i){var u=n.apply(t,r);function c(n){e(u,o,i,c,a,"next",n)}function a(n){e(u,o,i,c,a,"throw",n)}c(void 0)})}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t="drop";function r(e,n){return o.apply(this,arguments)}function o(){return(o=n(regeneratorRuntime.mark(function e(n,t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:void 0!==n.connections[t]&&delete n.connections[t];case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}var i={name:t,listener:r};exports.default=i;
...
var process = require("process");
var e=require("process");Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0,require("regenerator-runtime/runtime");var t=s(require("socket.io-client")),n=s(require("./src/events.js")),r=s(require("./src/untils/peer.js")),i=s(require("./src/untils/random.js")),o=s(require("./src/models/dataModel.js"));function s(e){return e&&e.__esModule?e:{default:e}}function a(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function c(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{};t%2?a(Object(n),!0).forEach(function(t){u(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):a(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function u(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function l(e,t,n,r,i,o,s){try{var a=e[o](s),c=a.value}catch(u){return void n(u)}a.done?t(c):Promise.resolve(c).then(r,i)}function f(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var o=e.apply(t,n);function s(e){l(o,r,i,s,a,"next",e)}function a(e){l(o,r,i,s,a,"throw",e)}s(void 0)})}}function h(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function p(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function v(e,t,n){return t&&p(e.prototype,t),n&&p(e,n),e}var d=function(){function e(){h(this,e),this.socketOptions={host:"foxql-signal.herokuapp.com",port:null,protocol:"https"},this.networkStableConnectionSize=50,this.networkMaxConnectionSize=100,this.myPeerId=null,this.iceServers=[{urls:"stun:stun.stunprotocol.org:3478"},{urls:"stun:stun.l.google.com:19302"}],this.avaliableUseKeys=["socketOptions","maxConnections"],this.simulatedListenerDestroyTime=400,this.simulatedListenerAfterDatachannelTimeout=400,this.connections={},this.peerEvents={}}return v(e,[{key:"open",value:function(){var e=this;"number"==typeof this.socketOptions.port?this.socketOptions.port=":"+this.socketOptions.port:this.socketOptions.port="",this.socket=(0,t.default)("".concat(this.socketOptions.protocol,"://").concat(this.socketOptions.host).concat(this.socketOptions.port),{reconnection:!1}),this.loadEvents(),this.socket.on("connect",function(){e.myPeerId=e.socket.id,e.socket.on("eventSimulation",function(){var t=f(regeneratorRuntime.mark(function t(n){var r,i,o;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return r=e.peerEvents[n.listener]||!1,i=n.data._by,t.next=4,r[0](n.data);case 4:o=t.sent,null==e.connections[i]&&(n.data._simulate=!0,o&&e.simulationIsDone(n));case 6:case"end":return t.stop()}},t)}));return function(e){return t.apply(this,arguments)}}()),e.socket.emit("call",e.networkStableConnectionSize)})}},{key:"simulationIsDone",value:function(e){this.socket.emit("simulationDone",{to:e.data._by,targetListener:e.answerWaitingListener})}},{key:"onPeer",value:function(e,t){null==this.peerEvents[e]&&(this.peerEvents[e]=[]),this.peerEvents[e].push(t.bind(this))}},{key:"emitPeer",value:function(e,t){if(null==this.peerEvents[e])return!1;this.peerEvents[e].forEach(function(e){e(t)})}},{key:"loadEvents",value:function(){var e=this;n.default.forEach(function(t){e.socket.on(t.name,function(n){t.listener(e,n)})})}},{key:"use",value:function(e,t){this.avaliableUseKeys.includes(e)&&(this[e]=c(c({},this[e]),t))}},{key:"broadcast",value:function(e){var t=this,n=(0,o.default)(e);if(n.error)return n;e.data._by=this.myPeerId;var r=(0,i.default)();e.answerWaitingListener=r,this.socket.emit("eventSimulation",e);var s=[];this.socket.on(r,function(e){s.push(e)}),setTimeout(function(){if(delete t.socket._callbacks["$"+r],!(s.length<=0)){s.forEach(function(e){if(null==t.connections[e]){var n=t.newPeer(e);n.createOffer(),t.connections[e]=n}});var n=t.connections,i=JSON.stringify(e);setTimeout(function(){for(var e in n){var t=n[e],r=t.dataChannel;null!=r&&("open"===r.readyState&&t.send(i))}},t.simulatedListenerAfterDatachannelTimeout)}},this.simulatedListenerDestroyTime)}},{key:"send",value:function(e,t){var n=(0,o.default)(t);if(n.error)return n;var r=this.connections[e]||!1;if(!r)return!1;t.data._by=this.myPeerId;var i=JSON.stringify(t);r.send(i)}},{key:"newPeer",value:function(e){return new r.default(this.iceServers,this.socket,e,this.emitPeer.bind(this))}}]),e}(),m=d;exports.default=m;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=a(require("@foxql/foxql-index")),t=a(require("@foxql/foxql-peer")),n=a(require("./core/storage.js")),r=a(require("./events.js")),o=a(require("./core/tokenization.js")),i=a(require("./collections.js"));function a(e){return e&&e.__esModule?e:{default:e}}function s(e,t,n,r,o,i,a){try{var s=e[i](a),u=s.value}catch(c){return void n(c)}s.done?t(u):Promise.resolve(u).then(r,o)}function u(e){return function(){var t=this,n=arguments;return new Promise(function(r,o){var i=e.apply(t,n);function a(e){s(i,r,o,a,u,"next",e)}function u(e){s(i,r,o,a,u,"throw",e)}a(void 0)})}}function c(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function l(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{};t%2?c(Object(n),!0).forEach(function(t){f(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):c(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function f(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function p(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function h(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function v(e,t,n){return t&&h(e.prototype,t),n&&h(e,n),e}var d=function(){function a(){p(this,a),this.storageOptions={name:"foxql-storage",interval:100,saveInterval:!1},this.currentCollections=[],this.useAvaliableObjects=["serverOptions","storageOptions"],this.databaseSaveProcessing=!1,this.database=new e.default,this.peer=new t.default}return v(a,[{key:"use",value:function(e,t){this.useAvaliableObjects.includes(e)&&(this[e]=l(l({},this[e]),t))}},{key:"openNativeCollections",value:function(){var e=this;i.default.forEach(function(t){e.database.pushCollection(t);var n=t.collectionName;e.currentCollections.push(n),e.database.useCollection(n).registerAnalyzer("tokenizer",o.default)})}},{key:"open",value:function(){var e=this.storageOptions.saveInterval||!1;e&&(this.storage=new n.default(this.storageOptions),this.loadDumpOnStorage()),e&&this.indexDatabaseLoop(),this.peer.open()}},{key:"loadDumpOnStorage",value:function(){var e=this,t=this.storage.get();if(t&&"string"==typeof t)try{this.database.import(JSON.parse(t)),i.default.forEach(function(t){var n=t.collectionName;e.database.useCollection(n).registerAnalyzer("tokenizer",o.default)})}catch(n){throw Error(n)}}},{key:"indexDatabaseLoop",value:function(){var e=this;setInterval(function(){e.currentCollections.forEach(function(t){var n=e.database.collections[t];if(n.waitingSave&&!e.databaseSaveProcessing){e.databaseSaveProcessing=!0;var r=e.database.export();e.storage.set(JSON.stringify(r)),e.databaseSaveProcessing=!1,n.waitingSave=!1}})},this.storageOptions.interval)}},{key:"pushEvents",value:function(e){var t=this;e.forEach(function(e){var n=r.default[e]||!1;n&&t.peer.onPeer(n.name,n.listener.bind(t))})}},{key:"publishDocument",value:function(e,t){return"string"==typeof t&&(!!this.currentCollections.includes(t)&&void this.peer.broadcast({listener:"onDocument",data:{document:e,collection:t}}))}},{key:"randomString",value:function(){return Math.random().toString(36).substring(0,30).replace(/\./gi,"")}},{key:"search",value:function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o,i,a,s,c,l,f=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.query,r=t.timeOut,o=t.collections,i=[],a={},s=0,null==o&&(o=this.currentCollections),c=this.randomString(),l={listener:c,query:n,collections:o},this.peer.broadcast({listener:"onSearch",data:l}),this.peer.onPeer(c,function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:for(o in n=t.results,r=function(e){var t=n[e];s+=t.length,t.forEach(function(t){null==a[t.document.documentId]&&(t._collection=e,i.push(t),a[t.document.documentId]=1)})},n)r(o);case 3:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),e.abrupt("return",new Promise(function(e,t){setTimeout(function(){i.sort(function(e,t){return t.document.score-e.document.score}),delete f.peer.peerEvents[c],e({results:i,count:s})},r+500)}));case 10:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"randomDocument",value:function(e,t){var n=this,r=e.limit,o=e.collection,i=e.timeOut,a=this.randomString();this.peer.broadcast({listener:"onRandom",data:{limit:r,collection:o,listener:a}});var s=[];this.peer.onPeer(a,function(){var e=u(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:s=s.concat(t.results);case 1:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),setTimeout(function(){t(s),delete n.peer.peerEvents[a]},i)}},{key:"findDocument",value:function(){var e=u(regeneratorRuntime.mark(function e(t){var n,r,o,i,a,s=this;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.collection,r=t.ref,o=t.timeOut,i=this.randomString(),a=[],this.peer.onPeer(i,function(){var e=u(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:a.push(t.document);case 1:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}()),this.peer.broadcast({listener:"onDocumentByRef",data:{listener:i,ref:r,collection:n}}),e.abrupt("return",new Promise(function(e){setTimeout(function(){e(a),delete s.peer.peerEvents[i]},o)}));case 6:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"dropPeer",value:function(e){void 0!==this.peer.connections[e]&&(this.peer.connections[e].dataChannel.close(),delete this.peer.connections[e])}}]),a}(),m=d;exports.default=m;
